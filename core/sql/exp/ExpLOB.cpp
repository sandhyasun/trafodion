...
Lng32 ExpLOBoper::initLOBglobal(void *& exLobGlobals, void * lobHeap)
{
  // call ExeLOBinterface to initialize lob globals
  ExpLOBinterfaceInit(exLobGlobals, lobHeap);
...
Lng32 ExpLOBoper::createLOB(void * exLobGlob, void * lobHeap, 
...
Lng32 ExpLOBoper::compactLobDataFile(void *exLobGlob,ExLobInMemoryDescChunksEntry *dcArray,Int32 numEntries,char *tgtLobName,Int64 lobMaxChunkMemSize, void *lobHeap, char *hdfsServer, Int32 hdfsPort, char *lobLoc)
{
  Int32 rc = 0;
  void * exLobGlobL = NULL;
  // Call ExeLOBinterface to create the LOB
...
Int32 ExpLOBoper::purgeBackupLobDataFile(void *exLobGlob,char *lobName, void *lobHeap, char * hdfsServer, Int32 hdfsPort, char *lobLoc)
{
  Int32 rc = 0;
  void * exLobGlobL = NULL;
  if (exLobGlob == NULL)
...
Lng32 ExpLOBoper::dropLOB(void * exLobGlob, void * lobHeap,
			  char * lobLoc,Int32 hdfsPort, char *hdfsServer,
			  Int64 uid, Lng32 num)
{
  char buf[101];
